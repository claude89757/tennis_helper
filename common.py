...
def get_free_tennis_court_infos_for_szw(date: str, proxy_list: list, time_range: dict) -> dict:
    ...
    for index in index_list:
        ...
        headers = {
            ...
            "Accept-Language": "zh-CN,zh",
            "Cookie": "ASP.NET_SessionId=yymv1gpyqgelzsqtiq5o4cmq; HT.LoginType.1=20; HT.App.Type.1=10; HT.Weixin."
                      "ServiceType.1=30; .AspNet.ApplicationCookie=oUQAi_0nFADjkeIPeJR-Jd5mg0HKulTP-UHR9XBsJMBQoOw"
                      "mdplYz-ldDz1CprPRXRRTChd3yjReHbeZk9SRQz_J8OXB2yGq9KGhBBUth74f0kVzk4CPnA1bSPS-kATmWrr9c9LZsL"
                      "izulF5VUs8kaDhOBfY1LSG6An1l_OAkKRumheCcRyPelFUU9FK1JRqW24TGpbGum58J7j9pFMrjVh6xs-qoT76TS1q_O"
                      "R7tY7NCBtWFvwXNVweWhSTfGUphmlWk3N_hwp_MMq7ka4GrzazzUPBuw5MHIspYEWnBh316rlyE7noJrv9rmhCkCRgsX"
                      "uWJrdqHDfL8Ojcz0F9qHWvGK3RRZZ4egmHusMv82JxnCbhNXEpYkcrfytqK5fKOgWgb_DER58YKSDbrS63Xvw_fyQcV"
                      "mb4DBwAwRpu2giSezJ27lVPhkvjQxLjln9DLv_hyQSHlLHeFGcLY-HXU4mERVgKTa9efEsFFMp4LVj3dlitT4DEZju"
                      "ZorZwgmUx9jSjHqpsIRD7Par50o0t5v1Ve-LoSWhxfkLRXFQOlkcURXJ4I1TXHwC0beYXDcd5fzKBMqGPsBWjYduNYn0j"
                      "wPZbbVm0PeE1AwmTzRcQxWI3cI02; HT.Weixin.AppID.1=wx6b10d95e92283e1c; HT.Weixin.OpenID.1=oH5RL"
                      "5EWB5CjAPKVPOOLlfHm1bV8; HT.EmpID.1=4d5adfce-e849-48d5-b7fb-863cdf34bea0; HT.IsTrainer.1=F"
                      "alse; HT.PartID.1=b700c053-71f2-47a6-88a1-6cf50b7cf863; HT.PartDisplayName.1=%e6%b7%b1%e5%9"
                      "c%b3%e6%b9%be%e4%bd%93%e8%82%b2%e4%b8%ad%e5%bf%83; HT.ShopID.1=4f195d33-de51-495e-a345-09"
                      "b23f98ce95; HT.ShopDisplayName.1=%e6%b7%b1%e5%9c%b3%e6%b9%be%e5%b0%8f%e7%a8%8b%e5%ba%8f; __"
                      "RequestVerificationToken_L3N6YmF50=yograwA027bDMg53nP-S5poCTWbpn55mlslRx3Vw-rYGYa0mMpz3BA"
                      "c4SONwqw4_p78tjRF5Txr17ODIH-optw7VpVE1; XSRF-TOKEN=5LHQ1X4GicLyTKV5Aj4WMNmxBUSlfKXQBxoHNjQk"
                      "YhXwtN-x4QZFqBtZ1efeDj0gpvbOvD1kRi5iVoNOsReLGdKrFUtoZ_TigbLEdJqikwPK5hly4YrlnabKhgJe-m-pfI6VOg2",
