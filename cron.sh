...
*/1 * * * * /usr/bin/python3 /home/lighthouse/tennis_helper/watcher_for_hjd.py --item_name "金地威新" --watch_days 1 --send_sms 1 >> /home/lighthouse/tennis_helper/logs/bzgy_$(date +\%Y-\%m-\%d).log 2>&1
